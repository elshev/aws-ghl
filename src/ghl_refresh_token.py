...
def get_client_id():
    return ssm_client.get_parameter('GHL_CLIENT_ID', 'ClientId')


def get_client_secret():
    return ssm_client.get_parameter('GHL_CLIENT_SECRET', 'ClientSecret')


def get_refresh_token():
    return ssm_client.get_parameter('GHL_REFRESH_TOKEN', 'RefreshToken')
